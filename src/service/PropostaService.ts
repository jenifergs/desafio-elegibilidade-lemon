...
public novaProposta = async (proposta: Cliente) => {
...
public calculaConsumeMedio = (proposta: Cliente) => {
...
return consumo / 12;
  ...
  public consultaRazoesInegebilidade = (proposta: Cliente, consumoMedio: number) => {
    ...
    console.log(proposta.tipoDeConexao, consumoMedio);
